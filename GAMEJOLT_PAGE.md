...
Undertale Mod Menu is an unofficial Windows fan tool for editing local Undertale save values and experimenting with route state.
...
- This does not include Undertale game files.
- This does not include downloaded GameJolt project files.
- This does not bypass GameJolt downloads, logins, creator permissions, or install instructions.
- Use it with your own legitimate copy of Undertale.
- Backups are created before save writes, but extreme save values can still make a save unstable.

## Tags

undertale, mod, save-editor, fangame, utility, windows, gamejolt, tools
